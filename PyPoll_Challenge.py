...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in counties:
            ...
            total_county_votes[county_name] = 0
...
print(f'total_county_votes: {total_county_votes}')
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in counties:
        ...
        county_votes = total_county_votes.get(county)
        # 6c: Calculate the percentage of votes for the county.

        #print(f'county_votes: {county_votes}')
    ...
    winning_county_summary = (
        f"\n-------------------------\n"
        f"Largest County Turnnout: {winning_county}\n"
        f"-------------------------\n\n")
